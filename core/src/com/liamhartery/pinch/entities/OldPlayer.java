...
public class OldPlayer extends Sprite {
    ...
    // constructor
    public OldPlayer(Texture texture, TiledMapTileLayer layer, int initial_health, final GameScreen gameScreen) {
        super(texture);
    ...
    * with almost every action the user performs.
    ...
    public boolean isNextToVoid() {
        tempTile = collisionLayer.getCell((int)(getX()/tileWidth),(int)(getY()/tileHeight)).getTile();
